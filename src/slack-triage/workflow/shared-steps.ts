...
import {
  ...
  DifficultySchema,
  type Difficulty,
} from "@/slack-triage/agent/complexity.agent";

/**
 * Schema for the intent classification result produced by the classify step.
 * Shared so the intake workflows can declare it as their input schema and the
 * intent object flows through the branch without type casts.
 */
